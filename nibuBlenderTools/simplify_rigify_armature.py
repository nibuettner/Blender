#================ TODOs ================
# move tgt armature to "Final" Collection
# rename Armature if it name is not "UE_Armature"
# delete PoseLib in tgt armature (make single-user copy + delete the newly created one)
# delete bone groups in target mesh (pose mode)
# reparent mesh to tgt armature with empty groups (object mode)
#   don't CTRL+P, instead change parent in object properties
#   and change parent in "Armature" modifier
# move mesh to "Final" Collection
#================ TODOs ================
